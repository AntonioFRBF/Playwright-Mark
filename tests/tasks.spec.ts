...
import { TasksPage } from './support/tasks'
...
test.describe('cadastro', () => {
    ...
    test('não deve permitir tarefas duplicadas', async ({ request }) => {
...
test.describe('ataualização', () => {
    test('deve concluir uma tarefa', async ({ request }) => {
        ...
        await tasksPage.shoeldBeDone(task.name)
    })
})
